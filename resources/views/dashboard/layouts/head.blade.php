    <meta charset="utf-8" />
    <title>هيئة النيابة الادارية | @yield('title')</title>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="{{asset('dashboard')}}/assets/images/icon/dt-apa.ico" />
    <!-- Css -->
    ...
    <!-- Icons Css -->
    <link href="{{asset('dashboard')}}/assets/libs/@mdi/font/css/materialdesignicons.min.css" rel="stylesheet" type="text/css">
