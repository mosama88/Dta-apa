...
@section('content')
    <div class="row mt-3">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dashboard.internet_lines.update', $internetLine->slug) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="prosecution_id" class="form-select form-control select2"
                                        ...
                                        @forelse ($other['prosecutions'] as $prosecution)
                                            <option @if (old('prosecution_id', $internetLine->prosecution_id) == $prosecution->id) selected="selected" @endif
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="code_line" type="text"
                                        value="{{ old('code_line', $internetLine->code_line) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="order_number" type="text"
                                        value="{{ old('order_number', $internetLine->order_number) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="internet_speed" type="text"
                                        value="{{ old('internet_speed', $internetLine->internet_speed) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="ip_address" type="text"
                                        value="{{ old('ip_address', $internetLine->ip_address) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="mac_address" type="text"
                                        value="{{ old('mac_address', $internetLine->mac_address) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="type_line" class="form-select @error('type_line') is-invalid @enderror"
                                        ...
                                        <option value="{{ TypeLineEnum::Internet->value }}" @selected(old('type_line', $internetLine->type_line->value) == TypeLineEnum::Internet->value)>
                                            {{ TypeLineEnum::Internet->label() }}
                                        </option>
                                        <option value="{{ TypeLineEnum::VPN->value }}" @selected(old('type_line', $internetLine->type_line->value) == TypeLineEnum::VPN->value)>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="governorate_id" class="form-select form-control select2"
                                        ...
                                        @forelse ($other['governorates'] as $governorate)
                                            <option @if (old('governorate_id', $internetLine->governorate_id) == $governorate->id) selected="selected" @endif
