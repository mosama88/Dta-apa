...
class ProsecutionExport implements FromArray, WithHeadings, WithStyles
{
    protected $data;

    public function __construct($prosecutions)
    {
        $this->data = $prosecutions->map(function ($prosecution) {
            return [
